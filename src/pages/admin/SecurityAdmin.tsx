    ...
    <div className="bg-black min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center py-20">
        ...
        >
          ...
          <p className="text-lg text-gray-300 mb-6">This is a placeholder for future security management features. Here you will be able to manage admin users, roles, and security logs.</p>
        </motion.div>
      </main>
      <Footer />
    </div>
