...
const stats = [
  { icon: <TrendingUp className="text-green-400" />, label: 'Posts', value: '150+' },
  { icon: <Users className="text-blue-400" />, label: 'Authors', value: '12+' },
  { icon: <Star className="text-yellow-400" />, label: 'Avg. Read Time', value: '5 min' },
];

const trendingTags = ['AI', 'Cloud', 'UX', 'Startups', 'Security', 'Data', 'Innovation'];
const authors = [
  { name: 'Priya S.', avatar: 'https://randomuser.me/api/portraits/women/44.jpg', bio: 'AI researcher and tech writer. Passionate about digital transformation.', linkedin: '#', twitter: '#' },
  { name: 'James L.', avatar: 'https://randomuser.me/api/portraits/men/32.jpg', bio: 'Cloud architect and security expert. Loves open source.', linkedin: '#', twitter: '#' },
  { name: 'Elena M.', avatar: 'https://randomuser.me/api/portraits/women/55.jpg', bio: 'UX designer and product strategist. Advocate for accessibility.', linkedin: '#', twitter: '#' },
];
const posts = [
  { title: 'The Future of AI in Business', excerpt: 'How AI is transforming industries and what to expect in 2025.', tag: 'AI', author: authors[0], date: '2024-06-01', featured: true, body: 'Full article content for The Future of AI in Business...', coverImage: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=800&q=80' },
  { title: 'Cloud Security Best Practices', excerpt: 'Protecting your data in a multi-cloud world.', tag: 'Security', author: authors[1], date: '2024-05-20', featured: true, body: 'Full article content for Cloud Security Best Practices...', coverImage: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80' },
  { title: 'UX Trends for Modern Apps', excerpt: 'Designing for delight and accessibility.', tag: 'UX', author: authors[2], date: '2024-05-10', featured: false, body: 'Full article content for UX Trends for Modern Apps...', coverImage: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=800&q=80' },
  // Add more posts as needed for pagination demo
];
...
const BlogPage = () => {
  ...
  const [authorModal, setAuthorModal] = useState<typeof authors[0] | null>(null);
  const [postModal, setPostModal] = useState<typeof posts[0] | null>(null);

  const filteredPosts = posts.filter(p =>
    (search === '' || p.title.toLowerCase().includes(search.toLowerCase())) &&
    (selectedTag === '' || p.tag === selectedTag)
  );
