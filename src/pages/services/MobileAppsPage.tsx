...
const MobileAppsPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <SEO 
        title="Mobile App Development | Tekvoro Technologies"
        description="Create powerful, user-friendly mobile applications for iOS and Android. We build native and cross-platform apps that deliver exceptional user experiences."
        keywords="mobile app development, iOS apps, Android apps, cross-platform development, mobile applications, app development, React Native, Flutter"
        ogImage="/images/mobile-apps-og.jpg"
        ogType="website"
        structuredData={{
