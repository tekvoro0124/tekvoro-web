...
import CorporateNewsSearchPopup from '../search/CorporateNewsSearchPopup';
    ...
    <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 md:px-16 py-6 bg-transparent">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          title="Search corporate news with AI"
        >
      ...
      {/* Corporate News Search Popup */}
      <CorporateNewsSearchPopup
        isOpen={newsSearchOpen}
        onClose={() => setNewsSearchOpen(false)}
        onSearchSubmit={(query) => {
          // Search will navigate to /news-search?q=query
        }}
      />
